...
| `audit_logs`            | `id, user_id, action, entity_type, entity_id, old_value, new_value, description, created_at`            | `src/lib/games.ts` (`updateGameStatusWithAudit`) via `pages/api/games/status.astro`                                                                                  |
