...
Token-optimized docs for `knekro-hub`. Load only what you need — each file is self-contained and front-matter tagged (`module`, `depends_on`) so you can grep before reading.
