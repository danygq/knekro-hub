...
| `pages/404.astro`              | 404 error page: "¿Cómo salgo de la tetera?" with emote image and return home CTA                                                                                                                                   | Layout, `@lucide/astro`                            | unmatched routes, `games/[id]`, `streams/[id]`     |
...
| `styles/*`                     | `global.css` entry → `tokens.css` (design tokens), `base.css` (incl. `[x-cloak]`), `utilities.css`; per-page `pages/games.css`, `pages/ranking.css`, `pages/streams.css`, `pages/game-detail.css`, `pages/404.css` | Tailwind v4                                        | Layout (`global.css`); pages                       |
